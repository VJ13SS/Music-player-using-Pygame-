...
Note: This project is made on mobile...and accordingly the dimensions and coordinates are taken ..Try to adjust for yours...
...
def main():
	...
	while play:		
		...
		pygame.draw.rect(BOARD, 'black', (0,0,BOARD_WIDTH, BOARD_HEIGHT))
